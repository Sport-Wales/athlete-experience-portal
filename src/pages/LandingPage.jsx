...
export default function LandingPage() {
  return (
    ...
    <section className="py-8 px-4 w-[90%] mx-auto bg-gradient-to-b from-white to-gray-50">
...
<section className="py-10 bg-gray-100">
  <div className="w-[90%] mx-auto">
    <h2 className="text-2xl md:text-3xl font-bold text-center text-[--color-sw-blue] mb-2">
      The Impact of Sharing
    </h2>
    <p className="text-xl text-[--color-sw-blue] text-center mb-8 pt-2 max-w-2xl mx-auto">
